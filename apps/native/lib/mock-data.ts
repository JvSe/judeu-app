...
export type NotificationTone = "primary" | "success" | "info" | "star";

export type NotificationGroup = {
  label: string;
  items: {
    id: string;
    icon: "arrow-forward" | "checkmark" | "chatbubble-ellipses" | "star" | "pricetag";
    ...
    items: [
      {
        ...
        icon: "arrow-forward",
        tone: "primary",
        title: "Carlos está a caminho — chega em ~12 min",
        meta: "Pedido #4821 · há 5 min",
        unread: true,
      },
      {
        id: "n2",
        icon: "checkmark",
        tone: "success",
        title: "Pagamento de R$ 84,90 confirmado via Pix",
        meta: "Pedido #4821 · há 26 min",
        unread: true,
      },
      {
        id: "n3",
        ...
        tone: "info",
        title: 'Carlos: "Cheguei na portaria, pode liberar?"',
        meta: "Chat · há 32 min",
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: "star",
        tone: "star",
        title: "Avalie o serviço de Roberto Silva",
        meta: "Reparo de sifão · ontem, 18:40",
        dim: true,
      },
      {
        id: "n5",
        icon: "pricetag",
        tone: "primary",
        title: "15% off na primeira limpeza — só esta semana",
        meta: "Promoção · ontem, 09:00",
        dim: true,
      },
    ],
  },
