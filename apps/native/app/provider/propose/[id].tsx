...
// Orçamento/negociação antes do aceite (RF-D5), lado prestador: propõe um novo
// valor ou responde a uma contraproposta do cliente, enquanto o pedido segue CREATED.
export default function ProviderPropose() {
    ...
    <Screen>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.currentCard}>
          ...
          <Text style={styles.currentClient}>Cliente: {order.client.name}</Text>
        </View>
        ...
        {pending && pending.byRole === "client" && (
          <View style={styles.pendingCard}>
            <Text style={styles.pendingLabel}>O cliente propôs um novo valor</Text>
        ...
        {pending && pending.byRole === "provider" && (
          <View style={styles.pendingCard}>
            ...
            <Text style={styles.pendingValue}>{moneyFromCents(pending.priceCents)}</Text>
            <Text style={styles.waitingText}>Aguardando resposta do cliente…</Text>
          </View>
        )}
