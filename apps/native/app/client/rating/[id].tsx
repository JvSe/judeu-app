...
const tags = ["Pontual", "Caprichoso", "Educado", "Preço justo"];
    ...
    <Screen>
      ...
      >
        ...
        <View style={styles.ratingCard}>
          <Avatar
            ...
            fontSize={21}
          />
          <Text style={styles.ratingQuestion}>Como foi com o {firstName}?</Text>
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + 16 }]}>
        {alreadyReviewed ? (
          ...
          >
            <Text style={styles.submitText}>Voltar aos pedidos</Text>
          </Pressable>
        ) : (
          <>
            <Pressable
            ...
            <Pressable onPress={() => router.replace("/client/orders")}>
